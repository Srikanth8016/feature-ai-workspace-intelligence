      ...
      <div className="relative z-10 w-full max-w-md p-8 mx-4 rounded-2xl bg-zinc-900/60 border border-zinc-800/80 backdrop-blur-xl shadow-2xl transition-all duration-300">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-zinc-400 mt-2">
            Get started on your collaborative workspaces
          </p>
        </div>

        {error && (
          <div className="mb-6 p-4 text-sm bg-red-500/10 border border-red-500/20 text-red-400 rounded-xl flex items-center gap-2 animate-in fade-in">
        ...
        {success && (
          <div className="mb-6 p-4 text-sm bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 rounded-xl flex items-center gap-2 animate-in fade-in">
            <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-zinc-950/50 border border-zinc-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none text-white text-sm rounded-xl placeholder-zinc-500 transition-all font-light"
                value={username}
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full mt-4 py-3 rounded-xl font-semibold text-white bg-gradient-to-r from-indigo-500 to-violet-600 hover:from-indigo-400 hover:to-violet-500 transition-all duration-300 transform active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-indigo-500/20"
          >
            {isLoading ? (
